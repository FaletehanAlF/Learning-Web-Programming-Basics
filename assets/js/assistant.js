...
(function () {
  ...
  var STATIC_QA = [
    ...
    { k: ['banding jurusan', 'bandingkan', 'bedanya apa', 'bagus mana', 'pilih antara', 'mending mana', 'perbandingan jurusan'], t: 'Ketik 2 nama jurusan sekaligus, mis. "informatika vs psikologi" — nanti saya bandingkan isi belajar, cocok untuk siapa, durasi & estimasi biaya.', l: 'Buka Live Chat', p: 'asisten', a: '' },
    ...
    { k: ['snbp vs snbt', 'snbt vs snbp', 'beda snbp', 'beda snbt', 'snbp snbt beda'], t: 'SNBP pakai nilai rapor (Feb–Mar, tanpa tes), SNBT pakai tes UTBK (Apr–Jun). Saran: jadikan SNBP rencana A, SNBT rencana B, Mandiri cadangan. Lihat jadwal di Tips.', l: 'Lihat Jadwal', p: 'index', a: '#tips' },
