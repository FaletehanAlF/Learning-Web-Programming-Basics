...
(function () {
  ...
  function render(k) {
    ...
    wrap.innerHTML =
      ...
      + '<span class="kampus-pill">Akreditasi ' + esc(k.akreditasi || '-') + '</span>'
      ...
      + '<div class="detail-stat"><small><i data-feather="dollar-sign"></i>UKT / semester</small><strong>' + esc(k.ukt_per_semester || '-') + '</strong></div>'
